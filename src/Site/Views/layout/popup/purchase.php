        ...
        <div class="modal-content">
            <div class="popup__wrp px-lg-5">
                <div class="popup__content mw-100">
                    ...
                    <div class="popup__text text-left"></div>
                    ...
                    <div class="popup__buttons">
                        <p class="fs-14 text-start">Мы понимаем, что вы с нами еще не работали, и знаем, что в сфере недвижимости много недобросовестных участников рынка. Поэтому, мы проверяем квартиры через ЕГРН, за счёт чего Ваше заселение в квартиру, выбранную на нашем сайте, будет безопасным.<br>
                            Чтобы заслужить ваше доверие, мы сначала предоставляем наши услуги по поиску квартиры, а потом уже берем основную оплату. В отличие от остальных мы работаем дистанционно и только до полного заселения, плюс вместо 100% от стоимости аренды, сборы за услуги сервиса фиксированные всего 99 руб на старте и 5791₽ по факту предоставления услуги.<br><br>
                            Продолжая, вы подтверждаете что я не являетесь агентом и готовы оплатить сборы за услуги сервиса.
                        </p>
