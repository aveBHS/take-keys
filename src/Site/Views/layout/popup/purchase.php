        ...
        <div class="modal-content">
            ...
            <div class="px-3 px-lg-4 pb-4">
                ...
                <div class="mb-4 text-center">
                    По выбранному объекту мы договариваемся о снижении размера аренды, что позволяет вам значительно сэкономить.
                    Это возможно, благодаря тому, что вы предупредите нас за 5 дней о решении освободить квартиру, и мы своевременно обеспечиваем собственникам рекламу и как следствие круглогодичное заселение без простоя.
                    <br><br>
                    В среднем, наши клиенты, при активном использование сервиса, заселяются за 24 часа и экономят 25 000 - 40 000 рублей со сделки, поэтому мы посчитали, что 287 руб. на старте с полным доступом к сервису и 5791 руб. по факту предоставления услуг – справедливая малая часть от того, что мы даём вам.
                </div>

                <div class="fw-semibold fs-18 mb-3" style="margin-top: 25px;">Оплачивая на старте 287 ₽ вы получаете полный доступ к сервису:</div>
                    ...
                    <form id="open-purchase-form" class="needs-validation loading" novalidate>
                        <div class="popup__buttons">
                            ...
                            <button type="submit" class="btn px-1 fw-500 btn-primary w-100 rounded-3 mt-4 position-relative vibrate" style="line-height: 1.2;">
                                <span class="fs-18">Получить доступ к контактам собственников по акции за 287 ₽</span>
                            </button>
