    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="px-3 px-lg-4 pb-4">
                <div class="popup__title text-center"><?=$name?>, для продолжения пользования сервисом, ознакомьтесь с условиями и порядком оплаты услуг</div>
                <div class="mb-4 text-center">
                    ...
                    <br><br>
                    В отличие от остальных мы работаем только до полного заселения, плюс вместо 100% от стоимости аренды, цена "Take Keys" фиксированная всего 209₽ на старте и 12990₽ по факту предоставления услуг.
                </div>
                ...
                <div class="accordion" id="tarif-take-keys__desc">
                        ...
                        <div class="icon-list">
                            ...
                            <div class="icon-list__item">
                                <div class="row gx-3 align-items-center">
                                    ...
                                    <div class="col">Доступ к базе актуальных объектов недвижимости <span class="text-nowrap">2001 - 2021г.</span></div>
                                </div>
                            </div>
                            <div class="icon-list__item">
                                <div class="row gx-3 align-items-center">
                            ...
                            <div class="icon-list__item">
                                <div class="row gx-3 align-items-center">
                                    ...
                                    <div class="col">Проверка недвижимости нашей системой</div>
                                </div>
                            </div>
                            <div class="icon-list__item">
                                <div class="row gx-3 align-items-center">
                    ...
                    <div class="text-center mt-5">
                        <div class="badge-yellow">Время на оформление заказа <span class="tarif-take-keys-2-timer fw-semibold">24:00</span></div>
                    </div>


                    <form id="open-purchase-form" class="needs-validation loading" novalidate>
                        <div class="popup__buttons">

                            <button class="btn p-1 fw-500 btn-outline-secondary w-100 rounded-3 mt-5" onclick="stayFree()" style="line-height: 1.2;">
                            ...
                            <div class="form-check form-check-box mt-5 text-start tarif-max__terms">
                                ...
                                <label class="auth__terms form-check-label text-dark fs-14" for="tarif-take-keys-2__terms" style="font-size: 10px;">
                                    Подтверждаю, что <a style="color:#a3cc4a" href="https://take-keys.com/documents#!/tab/359162567-3   ">уведомлен и согласен с условиями обслуживания и порядком оплаты услуг</a>. По факту предоставления услуг соглашаюсь оплатить <a style="color:#a3cc4a" href="https://take-keys.com/documents#!/tab/359162567-4">тариф "Take Keys"</a> стоимостью 12990₽, платёж осуществляется автоматически с привязанной к сервису карты после первой оплаты и действует до полного заселения.
                                </label>
                            </div>
                        </div>
                    </form>
                    ...
                    <?php } else { ?>
                        <form id="open-purchase-form" class="needs-validation loading" novalidate>
                            <div class="popup__buttons">
                                ...
                                <button type="submit" class="btn px-1 fw-500 btn-primary w-100 rounded-3 mt-4 position-relative disabled" style="line-height: 1.2;">
                                    <span class="fs-18">Подключено</span>
                                </button>

                                <div class="form-check form-check-box mt-5 text-start tarif-max__terms">
                                    <input class="form-check-input disabled" type="checkbox" value="" name="terms" id="tarif-take-keys-2__terms" style="display: inherit" required checked disabled>
