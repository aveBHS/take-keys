...
<div class="modal fade tarif-take-keys" id="popup-tarif-take-keys" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="icon-list">
                    ...
                    <div class="icon-list__item">
                        <div class="row gx-3 align-items-center">
                            ...
                            <div class="col">Эксклюзивные объекты которых нет на бесплатных досках объявлений</div>
                        </div>
                    </div>
                    <div class="icon-list__item">
                        <div class="row gx-3 align-items-center">
                            ...
                            <div class="col">Персональный менеджер, который на себя берёт все телефонные переговоры и организацию встреч</div>
                        </div>
                    </div>
                    <div class="icon-list__item">
                        <div class="row gx-3 align-items-center">
                    ...
                    <div class="icon-list__item">
                        <div class="row gx-3 align-items-center">
                            ...
                            <div class="col">Методичку по заселению за 24 часа</div>
                        </div>
                    </div>
                    <div class="icon-list__item">
                        <div class="row gx-3 align-items-center">
                            ...
                            <div class="col">Поддержку до полного заселения</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php } else { ?>
                <button class="btn px-1 fw-500 btn-primary w-100 rounded-pill" type="button" disabled>
