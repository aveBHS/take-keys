        ...
        <div class="modal-content">
            <div class="popup__wrp px-lg-5">
                <div class="popup__content mw-100">
                    <div class="popup__title">Уважаемый <?=$name?>, благодарим вас за интерес к Take Keys и искренне желаем удачного заселения.</div>
                    <div class="popup__text text-left">Узнавайте первыми о новых, подходящих вариантах сразу после их размещения в сервисе, проверяйте любой объект на актуальность онлайн, наш робот прозвонит понравившиеся вам объекты, проведёт переговоры и моментально уведомит о результате в итоге сэкономит вам время и деньги.</div>
                    ...
                    <div class="popup__buttons">
                        <p class="fs-14 text-start">

                        </p>
                        <a class="btn btn-dark px-5" data-bs-target="#popup-tarif-max-2" data-bs-toggle="modal" data-bs-dismiss="modal">Продолжить</a>
                        <!--p class="fs-14 text-start"><br>Продолжая, вы подтверждаете что я не являетесь агентом и готовы оплатить сборы за услуги сервиса.</p-->
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            <div class="popup__wrp">
                <form id="tarif-max__form" class="popup__content needs-validation" novalidate>
                    ...
                    <div class="popup__text">Мы понимаем, что вы с нами еще не работали, и знаем, что в сфере недвижимости много недобросовестных участников рынка. Поэтому, мы проверяем квартиры через ЕГРН, за счёт чего Ваше заселение в квартиру, выбранную на нашем сайте, будет безопасным.<br>
                        Чтобы заслужить ваше доверие, мы сначала предоставляем наши услуги по поиску квартиры, а потом уже берем основную оплату. В отличие от остальных мы работаем дистанционно и только до полного заселения, плюс вместо 100% от стоимости аренды, сборы за услуги сервиса фиксированные всего 99 руб на старте и 5791₽ по факту предоставления услуги.</div>
