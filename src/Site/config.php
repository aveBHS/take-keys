...
const MESSENGER_SCENARIOS = [
    ...
    "В продолжение разговора отправляю информацию и прямую ссылку на объявления владельца.\n\nЕсли вы настроены серьёзно - записывайтесь на встречу пока предложение ещё актуально.\n\nДля того, чтобы записаться на встречу с собственником в объявление на сайте [URL] кликните кнопку 'Записаться на встречу'.\n\nГарантии работы с Take-Keys:\n\nКаждое объявление проверяется  автоматически через Единый Государственный Реестр Недвижимости, срок проверки до 48 часов.\n\n\nОтзывы довольных, заселенных пользователей в день обращения на YouTube:\nhttps://youtube.com/channel/UCkz633PYeTlr08Qcy-y0A9w\n\n\nС уважением система недвижимости take-keys.ru"
];