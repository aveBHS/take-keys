...
const MESSENGER_SCENARIOS = [
    "Хорошо, сейчас есть время можете позвонить на 2-3 минуты, обсудим вопросы и если все хорошо договоримся о встрече или пишите здесь в чате, но лучше конечно голосом.",
